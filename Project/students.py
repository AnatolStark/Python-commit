...
# Bad approach! SQL injection danger! Plochoi podhod. Opasnost!
# insert_query = f"INSERT INTO students VALUES ('{first_name}', '{last_name}', {age});"

# Good approach!

#insert_query = "INSERT INTO students VALUES (?, ?, ?);"  # 2.

# cursor.execute(insert_query, (first_name, last_name, age))
# cursor.execute(insert_query, jane)

 #for student in students:
 	 #cursor.execute(insert_query, student)sqlite

#cursor.executemany(insert_query, students)  # 3.
